      ...
      elseif (strlen($firstName)<3) {
       ...
       $message="That id number already exists";
        ...
        $password_hash=password_hash($password,PASSWORD_DEFAULT);
         $sql = "INSERT INTO users(firstName,lastName,idNumber,mobile,email,userType,password) VALUES ('$firstName','$lastName','$idNumber','$mobile','$email','$user','$password_hash')";
...
<div class="alert alert-success col-md-6" id="message" style="<?php if ($message != "") {?> display: block; margin-left: 350px; <?php } ;?>">
 ...
 <div class="container register" style="background-color: #E4E1E1;width: 50%;margin-bottom: 8px;">
     <h1><label> Donate Blood Registration</label></h1>
     <div class="row">
       <div class="col-md-6 col-lg-6">
       <form method="POST" action="userReg.php">
         <div class="form-group"style="width: 180%;margin-left:40px;">
         ...
         <input type="submit" name="register" value="Register"style="width:80%;margin-left:200px;" class="btn btn-success">
         <a href="login.php" style="margin-left:50px;">Already have an account?</a>
        <br>
        <br>
       </div>
