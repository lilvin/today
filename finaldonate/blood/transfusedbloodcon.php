...
//add record
 ...
 $serial = $_POST['serial'];
   $tdate = $_POST['tdate'];
   $tstatus="Y";
	  if(!empty($serial)  && !empty($tdate)){
	   
	   $sql = "UPDATE processedblood SET tdate='$tdate',transfusionStatus='$tstatus' WHERE serial=$serial";
...
$serial = $_POST['serial'];
 ...
 $serial =$_POST['serial'];
  $tdate =$_POST['tdate'];
   ...
   if(!empty($tdate) && !empty($serial)){
 $query= "UPDATE processedblood SET  tdate='$tdate' WHERE serial='$serial' ";
if ($query_run= mysqli_query($con,$query)){
