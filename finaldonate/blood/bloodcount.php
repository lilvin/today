...
if (isset($_POST['all']))
	...
	//blood group A-
	$query ="SELECT * FROM processedblood WHERE (type='A-') AND transfusionStatus LIKE 'N'";
  
  if ($query_run= mysqli_query($con,$query)){
  	
        $ancount= mysqli_num_rows($query_run);
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP B+
	$query ="SELECT * FROM processedblood WHERE (type='B+')transfusionStatus LIKE 'N'";
...
//BLOOD GROUP b-
	$query ="SELECT * FROM processedblood WHERE (type='B-') AND transfusionStatus LIKE 'N'";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP Ab+
	$query ="SELECT * FROM processedblood WHERE (type='AB+') AND transfusionStatus LIKE 'N'";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP O+
	$query ="SELECT * FROM processedblood WHERE (type='O+')AND transfusionStatus LIKE 'N'";
...
/////////blood count per hospital
	...
	//blood group A-
	$query ="SELECT * FROM processedblood WHERE (type='A-' AND hospital='$hospital'AND transfusionStatus LIKE 'N')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP B+
	$query ="SELECT * FROM processedblood WHERE (type='B+' AND hospital='$hospital'AND transfusionStatus LIKE 'N')";
...
//BLOOD GROUP b-
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP Ab+
	$query ="SELECT * FROM processedblood WHERE (type='AB+' AND hospital='$hospital'AND transfusionStatus LIKE 'N')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP O+
	$query ="SELECT * FROM processedblood WHERE (type='O+' AND hospital='$hospital' AND transfusionStatus LIKE 'N')";
