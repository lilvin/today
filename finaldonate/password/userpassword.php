...
$message='';
 ...
 if (logged_in()) {
  ...
  if(!empty($current_password) && !empty($password) && !empty($confirm_password)){
    ...
    $sql=$con->query("SELECT * FROM users WHERE email='$email' AND userType='$userType'");
    $return=mysqli_fetch_assoc($sql);
   //$query ="SELECT * FROM users WHERE email='$email' AND password='12345'";
  // var_dump($sql);
  //      die(); 
    $decryptPassword=password_verify($current_password,$return['password']);
...
<div id="templatemo_main">
 ...
 <div class="container change" style="background-color: #E4E1E1;width:40%;margin-bottom:8px;">
    ...
    <div class="row">
       <div class="col-md-6 col-lg-6">
        <form method="POST" action="userpassword.php">
         ...
         <input type="submit" style="width: 100%;margin-left:120px;"name="change" value="Change Password" class="btn btn-success">
         <br>
         <br>
       </div>
      </form>
