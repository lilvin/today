...
if (logged_in()) {
  ...
  // var_dump($sql);
  //      die(); 
    $passwordVerify=password_verify($current_password,$return['password']);
    ...
    <div class="row">
       <div class="col-md-6 col-lg-6">
        <form method="POST" action="adminpassword.php">
         ...
         <input type="submit" name="change" style="width: 100%;margin-left:120px;"value="Change Password" class="btn btn-success">
       </div>
      </form>
      <br>
      <br>
